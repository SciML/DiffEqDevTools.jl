...
"""
test_convergence(Δts::AbstractArray,prob::AbstractSDEProblem)
...
"""
function test_convergence(Δts::AbstractArray,prob::AbstractSDEProblem;tspan=[0,1],numMonte=10000,save_timeseries=true,timeseries_steps=1,adaptive=false,kwargs...)
  N = length(Δts)
...
"""
function test_convergence(Δts::AbstractArray,Δxs::AbstractArray,prob::AbstractHeatProblem,convergence_axis;T=1,alg=:Euler)
...
"""
function test_convergence(Δxs::AbstractArray,prob::AbstractPoissonProblem)
